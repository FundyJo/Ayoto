/**
 * Video Hosters Provider - Utilities Module
 * 
...
/**
 * Utility functions for the hosters provider plugin
 */
const utils = {
  ...
  /**
   * Decode base64 string (safe for Unicode)
   ...
   * ROT13 encode/decode
   * @param {string} str - Input string
   * @returns {string} ROT13 processed string
   */
  rot13(str) {
