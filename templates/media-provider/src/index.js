/**
 * Media Provider Plugin - Main Entry Point
 * 
 * This is the main plugin file that exports the plugin implementation.
 * It uses a modular structure with separate files for API, parser, and utils.
 * 
 * @version 1.0.0
 * @license MIT
 */
...
const plugin = {
  ...
  async init(context) {
    ...
    console.log('Media Provider Plugin initialized');
  },
  ...
  async shutdown() {
    ...
    console.log('Media Provider Plugin shutdown');
  }
};
