const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/srt-parser-_6UrKeYK.js","assets/index-Cut7exT-.js","assets/vendor-CIv96BDj.js","assets/lodash-DWwsNxpa.js","assets/index-CXtu6Aoq.css","assets/ssa-parser-Bw0v_vv6.js","assets/errors-Ca9JonVB.js"])))=>i.map(i=>d[i]);
...
async function parseTextStream(stream, options) {
  var _a;
  const type = (_a = options == null ? void 0 : options.type) != null ? _a : "vtt";
  let factory;
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await __vitePreload(async () => {
          const { default: __vite_default__ } = await import("./srt-parser-_6UrKeYK.js");
          return { default: __vite_default__ };
        }, true ? __vite__mapDeps([0,1,2,3,4]) : void 0)).default;
        break;
      case "ssa":
      case "ass":
        factory = (await __vitePreload(async () => {
          const { default: __vite_default__ } = await import("./ssa-parser-Bw0v_vv6.js");
          return { default: __vite_default__ };
        }, true ? __vite__mapDeps([5,1,2,3,4]) : void 0)).default;
        break;
      default:
...
async function parseResponse(response, options) {
  ...
  const contentType = res.headers.get("content-type") || "", type = (_a = contentType.match(/text\/(.*?)(?:;|$)/)) == null ? void 0 : _a[1], encoding = (_b = contentType.match(/charset=(.*?)(?:;|$)/)) == null ? void 0 : _b[1];
...
class VTTParser {
  ...
  async init(init) {
    ...
    if (init.errors)
      ...
      }, true ? __vite__mapDeps([6,1,2,3,4]) : void 0)).ParseErrorBuilder;
  }
  parse(line, lineCount) {
    ...
    if (line === "") {
      if (this.c) {
        ...
        (_d = (_c = this.h).onRegion) == null ? void 0 : _d.call(_c, this.d);
        this.d = null;
      } else if (this.e === 1) {
        this.k(line, lineCount);
        (_f = (_e = this.h).onHeaderMetadata) == null ? void 0 : _f.call(_e, this.i);
      }
      this.e = 0;
    } else if (this.e) {
      switch (this.e) {
  ...
  k(line, lineCount) {
    ...
    if (lineCount > 1) {
      ...
      this.g((_a = this.f) == null ? void 0 : _a.r());
    }
  }
  q(line, lineCount) {
    var _a, _b, _c;
      ...
      if (SETTING_SEP_RE.test(settings[i])) {
        ...
        switch (name) {
          ...
          case "scroll":
            ...
            break;
          default:
            this.g((_a = this.f) == null ? void 0 : _a.v(name, value, line));
        }
        if (badValue) {
          this.g((_b = this.f) == null ? void 0 : _b.w(name, value, line));
        }
      }
    }
  }
      ...
      if (SETTING_SEP_RE.test(settings[i])) {
        ...
        switch (name) {
          ...
          case "align":
            ...
            break;
          default:
            this.g((_a = this.f) == null ? void 0 : _a.x(name, value, line));
        }
        if (badValue) {
          this.g((_b = this.f) == null ? void 0 : _b.y(name, value, line));
        }
      }
    }
  }
...
class CaptionsRenderer {
  constructor(overlay, init) {
    ...
    this.dir = (_a = init == null ? void 0 : init.dir) != null ? _a : "ltr";
...
const prod = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  CaptionsRenderer,
  ParseError,
  ParseErrorCode,
...
export {
  ...
  ParseErrorCode as c,
  prod as d,
  parseVTTTimestamp as p
};
//# sourceMappingURL=prod-B8yLbOr7.js.map
