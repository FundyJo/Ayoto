...
import { useAuth, useUserAnimeList, MediaListStatus } from '../../index.ts';
...
export const WatchingAnilist = () => {
  ...
  const animeData = animeList.lists.flatMap((list: { entries: { media: any }[] }) =>
    list.entries.map((entry) => ({
      ...
      status: apiStatusToUserFriendly[entry.media.status as keyof typeof apiStatusToUserFriendly] || 'Unknown',
