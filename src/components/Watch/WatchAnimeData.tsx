...
import { Seasons, Anime } from '../../index.ts';
...
const SeasonInfoColumn = styled.div`
  flex-grow: 1;
  display: block;
                ...
                <AnimeDataContainerMiddle>
                  <AnimeDataText>
                    ...
                    {animeData.releaseDate ? (
                      <p style={{ marginTop: '0.6rem' }}>
                        Jahr: <strong>{animeData.releaseDate}</strong>
                      </p>
                    ) : (
                      <p style={{ marginTop: '0.6rem' }}>
                        Jahr: <strong>Unbekannt</strong>
                      </p>
                    )}
                    {animeData.status && (
                      <p style={{ marginTop: '0.6rem' }}>
                    ...
                    {animeData.rating ? (
                      <p style={{ marginTop: '0.6rem' }}>
                        Bewertung: <strong>{animeData.rating}</strong>
                      </p>
                    ) : (
                      <p style={{ marginTop: '0.6rem' }}>
                        Bewertung: <strong>Unbekannt</strong>
                      </p>
                    )}
                    {animeData.studios && animeData.studios.length > 0 ? (
                      ...
                      <p style={{ marginTop: '0.6rem' }}>
                        Studios: <strong>Unbekannt</strong>
                      </p>
                    )}
                  </AnimeDataText>
                </AnimeDataContainerMiddle>
                <AnimeDataContainerBottom>
                  <AnimeDataText>
                    {animeData.totalEpisodes !== null ? (
                      <p style={{ marginTop: '0.2rem' }}>
                        Episoden: <strong>{animeData.totalEpisodes}</strong>
                      </p>
                    ) : (
                      <p style={{ marginTop: '0.2rem' }}>
                        Episoden: <strong>Unbekannt</strong>
                      </p>
                    )}
                    <p style={{ marginTop: '0.6rem' }}>
                      test: <strong>test</strong>
                    ...
                    {animeData.duration ? (
                      <p style={{ marginTop: '0.6rem' }}>
                        Dauer: <strong>{animeData.duration} min</strong>
                      </p>
                    ) : (
                      <p style={{ marginTop: '0.6rem' }}>
                        Dauer: <strong>Unbekannt</strong>
                      </p>
                    )}
                    {animeData.season ? (
                      <p style={{ marginTop: '0.6rem' }}>
                      ...
                      <p style={{ marginTop: '0.6rem' }}>
                        Staffel: <strong>Unknown</strong>
                      </p>
                    )}
                    {animeData.countryOfOrigin && (
                      <p style={{ marginTop: '0.6rem' }}>
                        Land: <strong>{animeData.countryOfOrigin}</strong>
                      </p>
                    )}
                    {/* timeUntilAiring */}
                      ...
                      <p style={{ marginTop: '0.6rem' }}>
                        <GenresContainer>
                          {animeData.genres.map((genre, index) => (
                            <GenreBubble key={index}>{genre}</GenreBubble>
                          ))}
                        </GenresContainer>
                      </p>
                    ) : (
                      <p style={{ marginTop: '0.6rem' }}></p>
                    )}
                  </AnimeDataText>
                </AnimeDataContainerBottom>
              </ParentContainer>
